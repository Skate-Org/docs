...
2. __Preconfirmation AVS (Eigenlayer)__<br/>
...
Our AVS is developed by leveraging [Othentic's stateless rollup framework](https://othentic.gitbook.io/main/stateless-rollup-framework). In depth details will be discussed in [Skate Preconfirmation AVS](/main/architecture/avs) section
