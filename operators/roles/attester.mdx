...
+ **Bootstrap node**: the known peer, also the aggregator in [multiaddr format](https://github.com/libp2p/specs/blob/master/addressing/README.md). This must by args\[1\] when invoking the CLI
